...
public class BitMapMod implements ModInitializer {
        ...
        public static final Block BLACK_BLOCK = new SemiconductorBlock(0);
        ...
        public static final Block CYAN_BLOCK = new SemiconductorBlock(0);
        public static final Block BLUE_BLOCK = new SemiconductorBlock(0);
        public static final Block PINK_BLOCK = new SemiconductorBlock(0);
        public static final Block WHITE_BLOCK = new SemiconductorBlock(0);
