...
public class BitMapMod implements ModInitializer {
    ...
    public void onInitialize() {
        Registry.register(Registry.BLOCK, new Identifier("bitmap", "yellow_semiconductor_block"),
                YELLOW_SEMICONDUCTOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier("bitmap", "red_semiconductor_block"), 
                RED_SEMICONDUCTOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier("bitmap", "green_semiconductor_block"),
                GREEN_SEMICONDUCTOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier("bitmap", "blue_semiconductor_block"),
                BLUE_SEMICONDUCTOR_BLOCK);
        Registry.register(Registry.ITEM, new Identifier("bitmap", "yellow_semiconductor_block"),
                new BlockItem(YELLOW_SEMICONDUCTOR_BLOCK, new Item.Settings().group(ItemGroup.REDSTONE).maxCount(64)));
        Registry.register(Registry.ITEM, new Identifier("bitmap", "red_semiconductor_block"),
                new BlockItem(RED_SEMICONDUCTOR_BLOCK, new Item.Settings().group(ItemGroup.REDSTONE).maxCount(64)));
        Registry.register(Registry.ITEM, new Identifier("bitmap", "green_semiconductor_block"),
                new BlockItem(GREEN_SEMICONDUCTOR_BLOCK, new Item.Settings().group(ItemGroup.REDSTONE).maxCount(64)));
        Registry.register(Registry.ITEM, new Identifier("bitmap", "blue_semiconductor_block"),
